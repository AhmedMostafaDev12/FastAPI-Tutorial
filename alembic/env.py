...
from app.models import Base  # Import the Base class from your models.py file
from alembic import context
from app.config import settings  # Import your settings from config.py
...
target_metadata = Base.metadata  # Use the metadata from your models.py file
